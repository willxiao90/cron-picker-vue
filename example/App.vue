<template>
  <div id="app">
    <el-form  label-width="120px">
      ...
      <el-form-item label="">
        <el-alert
        title="当使用 ui 选择调度周期时，一定会返回正确的 cron 表达式。但是当手动编辑 cron 表达式的时候，ui 不一定能准确表达，因为 ui 只考虑一些常见的情况，特殊情况 ui 无法表达。比如周期为分钟，cron 表达式为 10 */5 1-23 * * ?，ui 会正确显示分钟和小时，但是秒就无法展示。"
        type="warning">
      </el-alert>
      </el-form-item>
    </el-form>
